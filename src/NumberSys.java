public class NumberSys extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String fet=num.getText();
        int i=Integer.parseInt(fet);
        String fet1=Integer.toBinaryString(i);
        result.setText(fet1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String fet=num.getText();
        int i=Integer.parseInt(fet);
        String fet1=Integer.toOctalString(i);
        result.setText(fet1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String fet=num.getText();
        int i=Integer.parseInt(fet);
        String fet1=Integer.toHexString(i);
        result.setText(fet1);
